...
sequenceDiagram
    ...
    Note right of browser: The code in JS file allowed a new note to be created upon hitting submit, which Rerendered the page and Sent the note to the server.
```